...
var MasterPageComponent = /** @class */ (function () {
    ...
    MasterPageComponent.prototype.activateSidePanelStats = function () {
        ...
        this.httpRequestSubscription = this.httpUpdate.subscribe(function () {
            if (_this.userIsOnScreen) {
                ...
                _this.getWithdrawRankingDaily();
                _this.getDepositRankingDaily();
                _this.profitAndLoss = _this.totalDepositToday - _this.totalWithdrawToday;
            }
        });
    };
    ...
    MasterPageComponent.prototype.getWithdrawRankingDaily = function () {
        var _this = this;
    ...
    MasterPageComponent.prototype.getDepositRankingDaily = function () {
        var _this = this;
...
var DashboardService = /** @class */ (function () {
    ...
    DashboardService.prototype.emitWithrawToday = function (val) {
        this.withdrawToday.next(val);
    };
    DashboardService.prototype.emitDepositToday = function (val) {
