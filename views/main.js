...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(dashboardSrvc, commonSrvc) {
        ...
        this.bettingRankingHOMonthly = [];
        this.monthlyLoading = true;
        //deposit and withdraw ranking
        this.depositRankingDaily = [];
    ...
    //         this.totalConnectingMembers = res[1];
    //     },
    ...
    DashboardComponent.prototype.getWithdrawDepositToday = function () {
        ...
        this.dashboardSrvc.getDepositWithdrawToday()
            .subscribe(function (res) {
            _this.totalDepositToday = res[0]['TotalDepositToday'];
            _this.totalWithdrawToday = res[0]['TotalWithdrawToday'];
        }, function (error) { console.log('error' + error); });
    };
    DashboardComponent.prototype.getEmittedTotalRegisteredUser = function () {
        var _this = this;
...
var DepositManagementComponent = /** @class */ (function () {
    ...
    DepositManagementComponent.prototype.getPageCount = function () {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
...
var WithdrawManagementComponent = /** @class */ (function () {
    ...
    WithdrawManagementComponent.prototype.getPageCount = function () {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            _this.commonSrvc.getPageCount(_this.pageIndex)
                .subscribe(function (result) {
...
var GameLogComponent = /** @class */ (function () {
    ...
    GameLogComponent.prototype.getPageCount = function () {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            _this.commonSrvc.getPageCount(_this.pageIndex)
                .subscribe(function (result) {
...
/***/ "./src/app/components/log/point-log/point-log.component.css":
/*!******************************************************************!*\
  !*** ./src/app/components/log/point-log/point-log.component.css ***!
  \******************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/log/point-log/point-log.component.html":
/*!*******************************************************************!*\
  !*** ./src/app/components/log/point-log/point-log.component.html ***!
  \*******************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/log/point-log/point-log.component.ts":
/*!*****************************************************************!*\
  !*** ./src/app/components/log/point-log/point-log.component.ts ***!
  \*****************************************************************/
/*! exports provided: PointLogComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PointLogComponent", function() { return PointLogComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var PointLogComponent = /** @class */ (function () {
    function PointLogComponent() {
    }
    PointLogComponent.prototype.ngOnInit = function () {
    };
    PointLogComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-point-log',
            template: __webpack_require__(/*! ./point-log.component.html */ "./src/app/components/log/point-log/point-log.component.html"),
            styles: [__webpack_require__(/*! ./point-log.component.css */ "./src/app/components/log/point-log/point-log.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], PointLogComponent);
    return PointLogComponent;
}());
...
/***/ "./src/app/components/master-page/master-page.component.css":
/*!******************************************************************!*\
  !*** ./src/app/components/master-page/master-page.component.css ***!
  \******************************************************************/
/*! no static exports found */
...
var MasterPageComponent = /** @class */ (function () {
    function MasterPageComponent(commonSrvc, settingsSrvc, dashboardSrvc) {
        this.commonSrvc = commonSrvc;
    ...
    MasterPageComponent.prototype.onmouseleave = function (event) {
        if (event.clientY <= 0 || event.clientX <= 0 || (event.clientX >= window.innerWidth || event.clientY >= window.innerHeight)) {
            this.restartTimer();
            this.userIsOnScreen = false;
        }
    };
    MasterPageComponent.prototype.onmouseenter = function () {
        this.userIsOnScreen = true;
        ...
        this.updateSubscription = this.update.subscribe(function (count) {
            if (_this.userIsOnScreen) {
                ...
                if (count == _environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["environment"].httpRequestTimeout) {
                    ...
                    _this.updateSubscription.unsubscribe();
                }
            }
        });
    ...
    MasterPageComponent.prototype.toEnglish = function () {
        localStorage.setItem('language', 'english');
        window.location.reload();
    };
    //sidepanel stats
    MasterPageComponent.prototype.activateSidePanelStats = function () {
        ...
        this.httpRequestSubscription = this.httpUpdate.subscribe(function () {
            if (_this.userIsOnScreen) {
                ...
                _this.getTotalRegisteredUserToday();
                _this.getConnectingMembers();
            }
        });
    };
    MasterPageComponent.prototype.getTotalRegisteredUser = function () {
        var _this = this;
    ...
    MasterPageComponent.prototype.getTotalRegisteredUserToday = function () {
        var _this = this;
        this.dashboardSrvc.getTotalRegisteredUserToday()
            .subscribe(function (res) {
            _this.totalRegisteredUserToday = res['TotalRecentRegistered'];
            _this.dashboardSrvc.emitTotaRegisteredToday(res['TotalRecentRegistered']);
        }, function (error) { console.log('error' + error); });
    };
    MasterPageComponent.prototype.getConnectingMembers = function () {
        var _this = this;
        this.dashboardSrvc.getConnectingMembers()
            .subscribe(function (res) {
            _this.totalConnectingMembers = res[0];
            _this.dashboardSrvc.emitConnectingMembers(res[0].OnlineStatusCount);
        }, function (error) { console.log('error' + error); });
    };
    //sidepanel stats end
    ...
    ], MasterPageComponent.prototype, "onmouseleave", null);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["HostListener"])('mouseenter'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], MasterPageComponent.prototype, "onmouseenter", null);
    MasterPageComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_common_common_service__WEBPACK_IMPORTED_MODULE_1__["CommonService"], _services_settings_settings_service__WEBPACK_IMPORTED_MODULE_4__["SettingsService"], _services_dashboard_dashboard_service__WEBPACK_IMPORTED_MODULE_5__["DashboardService"]])
    ], MasterPageComponent);
...
var OneOnOneSupportComponent = /** @class */ (function () {
    ...
    OneOnOneSupportComponent.prototype.getPageCount = function () {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            _this.commonSrvc.getPageCount(_this.pageIndex)
                .subscribe(function (result) {
...
var BlackListComponent = /** @class */ (function () {
    ...
    BlackListComponent.prototype.getPageCount = function () {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            _this.commonSrvc.getPageCount(_this.pageIndex)
                .subscribe(function (result) {
...
var IPinquireComponent = /** @class */ (function () {
    ...
    IPinquireComponent.prototype.getPageCount = function () {
        var _this = this;
        var promise = new Promise(function (resolve, reject) {
            _this.commonSrvc.getPageCount(_this.pageIndex)
                .subscribe(function (result) {
...
var TranslateDirective = /** @class */ (function () {
    function TranslateDirective(el, commonSrvc) {
        this.el = el;
        this.commonSrvc = commonSrvc;
        this.text = [
            //sales
    ...
    TranslateDirective.prototype.toKorean = function () {
    ...
    TranslateDirective.prototype.toEnglish = function () {
        for (var _i = 0, _a = this.text; _i < _a.length; _i++) {
            var t = _a[_i];
    ...
    TranslateDirective = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"], _services_common_common_service__WEBPACK_IMPORTED_MODULE_1__["CommonService"]])
    ], TranslateDirective);
...
/***/ "./src/app/services/UserAuth/user-auth.guard.ts":
/*!******************************************************!*\
  !*** ./src/app/services/UserAuth/user-auth.guard.ts ***!
  \******************************************************/
...
var UserAuthService = /** @class */ (function () {
    ...
    UserAuthService.prototype.setLoggedIn = function (value) {
        this.authenticated = value;
    };
    UserAuthService.prototype.storeToken = function (token) {
        localStorage.setItem(_environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["environment"].tokenStorageKey, token);
    ...
    UserAuthService.prototype.login = function (UserName, Password) {
        ...
        console.log('sent');
        return this.http.post(_environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + '/Api/v1/Login/', {
            UserName: UserName,
            Password: Password
        })
...
/* harmony import */ var _services_UserAuth_user_auth_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/UserAuth/user-auth.service */ "./src/app/services/UserAuth/user-auth.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CommonService = /** @class */ (function () {
    function CommonService(http, router, userAuthSrvc) {
        this.http = http;
        this.router = router;
        this.userAuthSrvc = userAuthSrvc;
        this.httpOptions = {
    ...
    CommonService.prototype.setUserActive = function (value) {
        this.userIsActive = value;
    };
    Object.defineProperty(CommonService.prototype, "userActive", {
        get: function () {
    ...
    // return this.http.post(environment.apiUrl + '/Api/v1/Pagination/PostToken/', this.httpOptions)
    ...
    CommonService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_http__WEBPACK_IMPORTED_MODULE_1__["Http"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _services_UserAuth_user_auth_service__WEBPACK_IMPORTED_MODULE_5__["UserAuthService"]])
    ], CommonService);
...
var DashboardService = /** @class */ (function () {
    ...
    DashboardService.prototype.emitTotaRegisteredToday = function (val) {
        this.totalRegisteredTodayObservable.next(val);
    };
    DashboardService.prototype.emitConnectingMembers = function (val) {
...
/***/ "./src/app/services/log/gameLog/game-log.service.ts":
/*!**********************************************************!*\
  !*** ./src/app/services/log/gameLog/game-log.service.ts ***!
  \**********************************************************/
/*! exports provided: GameLogService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GameLogService", function() { return GameLogService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/http */ "./node_modules/@angular/http/fesm5/http.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../environments/environment.prod */ "./src/environments/environment.prod.ts");
...
/***/ "./src/app/services/notice/support/support.service.ts":
/*!************************************************************!*\
  !*** ./src/app/services/notice/support/support.service.ts ***!
  \************************************************************/
...
/***/ "./src/app/services/user/blackList/black-list.service.ts":
/*!***************************************************************!*\
  !*** ./src/app/services/user/blackList/black-list.service.ts ***!
  \***************************************************************/
...
var BlackListService = /** @class */ (function () {
    ...
    BlackListService.prototype.userInquire = function (UserAccountID, UserName) {
        return this.http.get(_environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + '/Api/v1/BlackList/Check/Blocked/UserAccountID/' + UserAccountID + '/UserName/' + UserName)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res.json(); }));
    };
    //blacklist user
    ...
    BlackListService.prototype.releaseUser = function (BlackListID, UserAccountID) {
        return this.http.get(_environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + '/Api/v1/BlackList/Update/BlackListID/' + BlackListID + '/UserAccountID/' + UserAccountID)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (res) { return res.json(); }));
    };
...
var environment = {
    ...
    // apiUrl : 'http://vuejs-ex-holdem-server.4b63.pro-ap-southeast-2.openshiftapps.com',
